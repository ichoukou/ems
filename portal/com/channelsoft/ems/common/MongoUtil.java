...
public enum  MongoUtil {
    ...
    private static final String[] readableMongoHosts = Config.getString(Config.DB_MONGO_ASSEMBLY).split(";");
    ...
    */
    public MongoCursor<Document> findByPage(String dbName,String collName, Bson filter, Bson orderBy, int pageNo, int pageSize) {
    	...
    	logger.debug("查询了db:"+dbName+"---collName:"+collName+"---filter:"+filter+"---orderBy:"+orderBy+"---pageNo:"+pageNo+"---pageSize:"+pageSize);
    ...
    */
    public long updateOne(String dbName,String collName, Bson filter,Bson update) {
    	...
    	logger.debug("更新了db:"+dbName+"---collName:"+collName+"---filter:"+filter+"---update:"+update);
    ...
    */
    public void insertOne(String dbName, String collName, Map<String, Object> map) {
    	...
    	logger.debug("更新了db:"+dbName+"---collName:"+collName+"---document:"+document);
