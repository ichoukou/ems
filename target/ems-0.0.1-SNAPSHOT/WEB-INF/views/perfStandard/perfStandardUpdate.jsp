...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">修改等级范围</h4>
      </div>
		  ...
		  <div class="popover-content">
			  <table style="position: relative; top: -30px;">
				  ...
				  <tr>
					  ...
					  <td>
						  <input id="updateFLowerLimit" type="text" >
					  </td>
					  <td align="right" for="exampleInputEmail1">分值上线：</td>
					  <td>
						  <input id="updateFHighLimit" type="text">
					  </td>
				  </tr>
				  <tr>
				  ...
				  <tr>
					  ...
					  <td>
						  <input type="text" id="updateFCoefficient">
					  </td>
					  <td align="right" for="exampleInputEmail1">考核结果：</td>
					  <td>
						  <input type="text" id="updateFAssessmentResult">
					  </td>
				  </tr>
				  </tbody>
			  </table>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="updateStandard()">保存</button>
      </div>
    </div>
  </div>
