...
<body class="gray-bg">
	<div class="panel-body" style="padding-bottom: 0px;">
		<div class="row">
			...
			<div class="form-group" style="float: left;margin-left: 10px;margin-top: 10px;">
				您正在查看房间【 <span id="fRoomNameShow"></span> 】的护理计划执行情况
				<input type="hidden" name="searchRoomFid" id="searchRoomFid"/>
			</div>
			</div>
		</div>	
		<div class="row">
			<div class="col-xs-6 col-md-2"><table id="tb_publicPlanPublic"></table></div>
			<div class="col-xs-6 col-md-10"><table id="tb_publicPlanExecute"></table></div>
		</div>
	</div>
	...
	<script
		src="${pageContext.request.contextPath}/script/app-resources/nursing/publicPlanExecute/index.js"></script>
	<script
