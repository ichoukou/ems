...
<div class="panel-body" style="padding-bottom:0px;">
					...
					<div class="form-group" style="margin-top: 15px">
						...
						<div class="col-sm-1" style="text-align: left;">
							<button type="button" style="margin-left: 20px" id="btn_clear"
								class="btn btn-primary" onclick="clearInput();">清空</button>
						</div>
						<div class="col-sm-1" style="text-align: left;">
    ...
    <div id="toolbar" class="btn-group">
        ...
        <button id="btn_add" type="button" class="btn btn-primary" data-toggle="modal" data-toggle="modal" data-target="#healthyAdd">
            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
        </button>
        <button id="btn_updheal" type="button" class="btn btn-primary" onclick="getUpdateHeal()"  >
            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>修改健康信息
        </button>
    </div>

    <table id="tb_oldManHealthy"></table>
</div>

<!-- 控制修改按钮 -->
<!-- <button id="addHealthy_btn" type="button" class="btn btn-default" data-toggle="modal" data-target="#healthyAdd" style="display:none">
</button> -->
<button id="updHealthy_btn" type="button" class="btn btn-default" data-toggle="modal" data-target="#healthyUpd" style="display:none">
</button>
<jsp:include  page="./oldManHealthyUpd.jsp"/>
<jsp:include  page="./oldManHealthyAdd.jsp"/>
