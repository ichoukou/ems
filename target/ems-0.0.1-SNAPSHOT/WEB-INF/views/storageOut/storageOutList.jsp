...
<div class="panel-body" style="padding-bottom:0px;">
            ...
            <form id="formSearch" class="form-horizontal">
                ...
                <div class="form-group row" style="margin-top:15px" style="margin-top: 10px">
                    ...
                    <div class="col-sm-6" style="text-align:right;" >
                        <button style="width: 100px" type="button" id="btn_clear" class="btn btn-primary" onclick="clearSelect()">清空</button>
                        <button style="width: 100px;margin-left: 50px" type="button" id="btn_query" class="btn btn-primary" onclick="queryOutDetailedList();">查询</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div id="toolbar" class="btn-group">
        ...
        <button  type="button" class="btn btn-primary"  onclick="go_to_add()">
            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>添加出库单
        </button>

        <button  type="button" class="btn btn-success"  onclick="go_to_update()">
            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>修改
        </button>

        <button  type="button" class="btn btn-default" onclick="go_to_delect()">
            <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>删除
        </button>
    </div>

    <table id="tb_storageOutDetailedList"></table>
</div>
...
<script src="${pageContext.request.contextPath}/script/app-resources/storage-goods/storageOut.js"></script>
...
<jsp:include  page="./storageOutAdd.jsp"/>
<jsp:include  page="./storageOutGoodsAdd.jsp"/>
