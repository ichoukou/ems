            ...
            <div class="modal-content" >
                ...
                <div class="modal-body" >
                    ...
                    <div class="form-group">
                        <label>所属父类</label>
                        <select class="form-control" id="add_father_id"  name="fHigherUpID" style="width: 250px;height: 30px">
                        <%--<input class="form-control" id="addfparentid">--%>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="addfname">分类名称</label>
                        <input type="text" class="form-control" id="addfname" placeholder="必填项" style="width: 250px;height: 30px">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"  onclick="addPayment()">保存</button>
                </div>
            </div>
        </div>
