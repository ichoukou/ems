...
<body class="gray-bg">
						...
						<div class="form-inline" role="serchFrom"
							style="margin-bottom: 10px;">
								...
								<div class="input-group">
			                	 ...
			                	 <!-- 3查询条件 -->
								<div class="input-group">
							    	<div class="input-group-addon">退住时间</div>
							      <input id="searchStartDateOut" type="text" onFocus="WdatePicker({readOnly:true})" style="width:120px;font-size:18px;font-weight: 100"/>
		                           &nbsp;-&nbsp;
								   <input id="searchEndDateOut" type="text" onFocus="WdatePicker({readOnly:true})" style="width:120px;font-size:18px;font-weight: 100" />
			                	</div>
								...
								<div class="form-group" style="margin-left: 20px;">
									...
									<button type="button" class="btn btn-primary btn-sm"
										onclick="queryRetirement()">搜索</button>
								</div>
						</div>
				</form>
			</div>
	...
	<script
		src="${pageContext.request.contextPath}/script/app-resources/expenses/retirementList.js"></script>
	<script
