...
<jsp:include  page="./empLeaveAdd.jsp"/>
<jsp:include  page="./empLeaveUpdate.jsp"/>
...
<script src="${pageContext.request.contextPath}/script/app-resources/empManager/empLeave.js"></script>
