            ...
            <div class="modal-content" >
                ...
                <div class="modal-body" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="old_update_father_id">
                        <select class="form-control" id="update_father_id" onchange="check_upd_RefatherId()" name="fHigherUpID" style="width: 250px;height: 35px">

                        </select>
                    </div>
                    <div class="form-group">
                        <label for="updfname">分类名称</label>
                        <input type="text" class="form-control" id="updfname" placeholder="必填项" style="width: 250px;height: 30px">
                        <label id="update_name_message" style="color: red;width: 250px;height: auto" >&nbsp;&nbsp;&nbsp;</label>
                    </div>
                    <%--<div class="form-group">--%>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"  onclick="updateCwglPayment()">修改</button>
                </div>
            </div>
        </div>
