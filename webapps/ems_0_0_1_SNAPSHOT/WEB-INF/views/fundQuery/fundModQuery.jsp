...
<div class="panel-body" style="padding-bottom:0px;">
        ...
        <div class="panel-body">
            <form id="formSearch" class="form-horizontal">
                <div class="form-group row" style="margin-top:15px">
                    <label class="control-label col-sm-1" for="ModOperator">变动人：</label>
                    <div class="col-sm-2">
                        <input class="form-control" name="ModOperator" id="ModOperator"style="width: 150px;" />
                    </div>
                    ...
                    <div class="col-sm-3" style="text-align:left;" >
                        ...
                        <button style="width: 100px;margin-left: 10px" type="button" id="btn_query" class="btn btn-primary" onclick="queryFundModList();">查询</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <table id="tb_fundModRecord"></table>
</div>
...
<script src="${pageContext.request.contextPath}/script/app-resources/fundQuery/fundModQuery.js"></script>
