...
<body class="gray-bg">
	<div class="panel-body" style="padding-bottom:0px;">
	  ...
	  <div id="toolbar" class="btn-group">
	   ...
	   <button id="btn_add" type="button" class="btn btn-primary" data-toggle="modal" data-target="#addModal" onclick="showDepartment()">
	  ...
	  <table id="tb_departmentManager"></table>
	</div>
 
	<!-- 控制修改按钮 -->
	<button id="update_btn" type="button" class="btn btn-default" data-toggle="modal" data-target="#updateModal" style="display:none">
	   </button>
	<jsp:include  page="./departmentManageAdd.jsp"/>
	<jsp:include  page="./departmentManageUpdate.jsp"/>
	...
	<script src="${pageContext.request.contextPath}/script/app-resources/empManager/departmentManage.js"></script>
