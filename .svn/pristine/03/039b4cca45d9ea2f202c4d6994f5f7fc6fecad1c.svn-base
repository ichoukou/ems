...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="${pageContext.request.contextPath}/script/lib/H+/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    ...
    <link href="${pageContext.request.contextPath}/script/lib/H+/css/plugins/iCheck/custom.css" rel="stylesheet">
</head>
...
<body class="gray-bg">
    ...
    <!-- iCheck -->
    <script src="${pageContext.request.contextPath}/script/lib/H+/js/plugins/iCheck/icheck.min.js"></script>
    <script>
