...
<jsp:include  page="./tFloorAdd.jsp"/>
<jsp:include  page="./tFloorUpdate.jsp"/>
...
<script src="${pageContext.request.contextPath}/script/app-resources/t-floor/tFloor.js"></script>
