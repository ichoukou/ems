        ...
        <div class="modal-dialog" id="modal" style="width:97%;">
            <div class="modal-content" style="background-color:#F0F0F0;">
                <div class=" panel-heading" style="background: #2F4050">
                    <div class="panel-heading" id="myModalLabel"  style="background: #2F4050 ;color: white">入库单新增
                        <span class=" control-label" id="in_message" style="color: red;width: 140px;height: auto">&nbsp;&nbsp;&nbsp;</span></div>
                </div>
                <div class="modal-body">
                    ...
                    <div align="center" class="popover-content" style="width:100%;" >
                        <div class="form-group row" >
                            ...
                            <label class="control-label col-sm-1" for="addfInStorageDate">入库日期</label>
                            <div class="col-sm-2" >
                                <input id="addfInStorageDate" class="form-control" type="text" onFocus="WdatePicker({lang:'zh-cn',minDate:'%y-%M-%d'})" style="width:150px;height: 30px" />
                            </div>
                        ...
                        <table id="add_storageInDetailed" class="table table-bordered" style="border:solid 2px #1AB394;">
                            <thead>
                            <tr>
                                <th  style="width: 40px">
