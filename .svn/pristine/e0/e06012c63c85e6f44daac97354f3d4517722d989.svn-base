...
public class _rateRangeAdd__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("WEB-INF/views/rateRange/rateRangeAdd.jsp"), -7315483528270994665L, false);
    _caucho_depends.add(depend);
  }
