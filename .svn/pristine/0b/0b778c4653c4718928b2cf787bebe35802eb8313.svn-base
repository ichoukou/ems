...
public class _roleManageUpdate__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("WEB-INF/views/roleManage/roleManageUpdate.jsp"), -1318386915373086174L, false);
    _caucho_depends.add(depend);
  }
